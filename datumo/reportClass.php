 ...
 */
	...
	public function loadReports($user_id, $target){
		...
		for($i=0;$row=$sql->fetch();$i++){
			echo "<tr><td><a href=javascript:void(0) onclick=window.open('".$this->pdo->getFolder()."/report.php?report=$row[0]','_blank','height=500px,width=720px,scrollbars=no'); title='$row[2]'>".$row[1]."</a></td></tr>";
		}
		echo "</table>";
	}
